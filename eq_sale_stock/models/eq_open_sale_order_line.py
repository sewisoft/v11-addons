...
class EqOpenSaleOrderLine(models.Model):
    _auto = False
    ...
    eq_state = fields.Selection([('cancel', 'Cancelled'), ('draft', 'Draft'), ('sale', 'Sale Order'),
                                 ('sent', 'Quotation Sent'), ('confirmed', 'Confirmed'), ('exception', 'Exception'),
                                 ('done', 'Done')], 'Status')
